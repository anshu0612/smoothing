...
if __name__ == "__main__":
    ...
    plot_certified_accuracy(
        "analysis/plots/vary_noise_svhn", "SVHN, vary $\sigma$", 1.5, [
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_0.12/test/sigma_0.12"), "$\sigma = 0.12$"),
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_0.25/test/sigma_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_0.50/test/sigma_0.50"), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_1.00/test/sigma_1.00"), "$\sigma = 1.00$"),
        ])
    plot_certified_accuracy(
        "analysis/plots/vary_train_noise_svhn_050", "SVHN, vary train noise, $\sigma=0.5$", 1.5, [
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_0.25/test/sigma_0.50"), "train $\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_0.50/test/sigma_0.50"), "train $\sigma = 0.50$"),
            Line(ApproximateAccuracy("data/certify/svhn/resnet110/noise_1.00/test/sigma_0.50"), "train $\sigma = 1.00$"),
        ])
